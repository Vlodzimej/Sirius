...
export class ApiService {
    ...
    get<T>(controller: string, params: any) {
        return this.http
            .get(
                this.baseUrl + 'api/' + controller + '?' + params,
    ...
    getById<T>(controller: string, id: any) {
        return this.http
            .get(
                this.baseUrl + 'api/' + controller + '/' + id,
                this.authenticationService.jwt()
            )
            .map((response: Response) => response.json() as T);
    }
    ...
    deleteIds(controller: string, ids: string[]) {
        return this.http.post(
            this.baseUrl + 'api/' + controller + '/ids',
            ids,
            this.authenticationService.jwt()
        );
    }
    ...
    dbReset() {
        return this.http.post(
            this.baseUrl + 'api/settings/dbreset',
            {},
            this.authenticationService.jwt()
        );
    }
    ...
    removeInvoices() {
        return this.http.post(
            this.baseUrl + 'api/invoice/remove_all',
            {},
            this.authenticationService.jwt()
        );
    }
